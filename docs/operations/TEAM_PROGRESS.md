...
| 2026-08-09 | DevOps + QA | EF tasarım-zamanı factory bağımsızlaştırıldı ve local tool manifestine `dotnet-ef` 9.0.2 eklendi | Factory artık çalışma dizini, `appsettings` veya secret gerektirmez; CI `dbcontext info` ile migration scaffold öncesi discovery/configuration sözleşmesini doğrular. |
