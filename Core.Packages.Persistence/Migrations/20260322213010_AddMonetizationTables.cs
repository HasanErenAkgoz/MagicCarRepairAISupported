...
{
    /// <inheritdoc />
    public partial class AddMonetizationTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(name: "IX_Subscriptions_ClientId", table: "Subscriptions", column: "ClientId");
            migrationBuilder.CreateIndex(name: "IX_Subscriptions_ClientId_Status", table: "Subscriptions", columns: new[] { "ClientId", "Status" });
            migrationBuilder.CreateIndex(name: "IX_Subscriptions_EndDate", table: "Subscriptions", column: "EndDate");
            migrationBuilder.CreateIndex(name: "IX_SubscriptionPayments_SubscriptionId", table: "SubscriptionPayments", column: "SubscriptionId");
            migrationBuilder.CreateIndex(name: "IX_SubscriptionPayments_PaymentNumber", table: "SubscriptionPayments", column: "PaymentNumber", unique: true);
            migrationBuilder.CreateIndex(name: "IX_SubscriptionPayments_ClientId", table: "SubscriptionPayments", column: "ClientId");
            migrationBuilder.CreateIndex(name: "IX_SubscriptionPayments_PaymentDate", table: "SubscriptionPayments", column: "PaymentDate");
            migrationBuilder.CreateIndex(name: "IX_Commissions_PaymentId", table: "Commissions", column: "PaymentId");
            migrationBuilder.CreateIndex(name: "IX_Commissions_ClientId", table: "Commissions", column: "ClientId");
            migrationBuilder.CreateIndex(name: "IX_Commissions_Status", table: "Commissions", column: "Status");
            migrationBuilder.CreateIndex(name: "IX_Commissions_PaymentDate", table: "Commissions", column: "PaymentDate");
            migrationBuilder.CreateIndex(name: "IX_UsageTracking_ClientId", table: "UsageTracking", column: "ClientId");
            migrationBuilder.CreateIndex(name: "IX_UsageTracking_ClientId_LimitType_CurrentPeriod", table: "UsageTracking", columns: new[] { "ClientId", "LimitType", "CurrentPeriod" }, unique: true);
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "UsageTracking");
            migrationBuilder.DropTable(name: "Commissions");
            migrationBuilder.DropTable(name: "SubscriptionPayments");
            migrationBuilder.DropTable(name: "Subscriptions");

            migrationBuilder.DropColumn(name: "CommissionAmount", table: "Payments");
            migrationBuilder.DropColumn(name: "CommissionRate", table: "Payments");
        }
    }
}
